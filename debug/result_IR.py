...
def train(ddp_rank):
    ...
    ir_videos = ['IR_1', 'IR_2', 'IR_3', 'IR_4']
    
    for irv in ir_videos:
        video_in = cv2.VideoCapture(os.path.join('sample', irv + '.mp4'))
        
        video_file_name = os.path.join('runs', config['PROJECT'], irv + '.mp4')
