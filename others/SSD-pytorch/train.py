...
def get_args():
    ...
    parser.add_argument("--save-folder", type=str, default="trained_models", help="path to folder containing model checkpoint file")
    parser.add_argument("--log-path", type=str, default="tensorboard/SSD")

    parser.add_argument("--model", type=str, default="ssd", choices=["ssd", "ssdlite"], help="ssd-resnet50 or ssdlite-mobilenetv2")
    ...
    parser.add_argument("--lr", type=float, default=2.6e-3, help="initial learning rate") # 0.0026
...
# steps: 118287 / 32 * 65 = 380000
# decay at 43, 54 epochs
# 43 * 380000 / 65 = 224615
# 54 * 380000 / 65 = 299230

# lr: 0.0026 * 32 / 32 = 0.0026
# weight decay: 0.0005


# batch size: 16
# steps: 118287 / 16 * 65 = 760000
# decay at 43, 54 epochs
# 43 * 760000 / 65 = 449230
# 54 * 760000 / 65 = 598461

# lr: 0.0026 * 16 / 32 = 0.0013
# weight decay: 0.0005

# batch size: 256
# steps: 118287 / 256 * 65 = 47600
# decay at 43, 54 epochs
# 43 * 47600 / 65 = 27753
# 54 * 47600 / 65 = 35769

# lr: 0.0026 * 256 / 32 = 0.0205
# weight decay: 0.0005


def main(opt):
    if torch.cuda.is_available():
        torch.distributed.init_process_group(backend='gloo', init_method='tcp://localhost:12342', rank=0, world_size=1)
